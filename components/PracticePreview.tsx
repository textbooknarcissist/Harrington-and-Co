    ...
    <section className="py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#0F1E2E] mb-6 serif">Areas of Expertise</h2>
          <div className="w-20 h-1 bg-[#8A6F3E] mx-auto mb-8"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          {previewAreas.map((area, idx) => (
            <div key={idx} className="p-10 border border-[#F7F5F0] hover:border-[#C6A75E]/30 transition-all duration-500 hover:shadow-xl group">
              ...
              <p className="text-[#4A5568] leading-relaxed font-light text-sm">{area.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          <a 
            href="#/practice" 
            className="inline-flex items-center px-10 py-5 border-2 border-[#0F1E2E] text-[#0F1E2E] font-bold uppercase tracking-[0.2em] text-xs hover:bg-[#0F1E2E] hover:text-[#F7F5F0] transition-all duration-300 group"
          >
