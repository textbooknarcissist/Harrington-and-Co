...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden pt-20 px-4">
      ...
      <div className="relative z-10 text-center max-w-5xl">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl text-[#F7F5F0] font-bold leading-[1.1] mb-6 md:mb-8 serif animate-in fade-in slide-in-from-bottom-6 duration-1000">
